      ...
      >
        ...
        >
          <div className="flex flex-row items-center gap-2">
            ...
            <div onClick={() => openModel(data?.id)} className="
            cursor-pointer ml-auto group/item w-6 h-6 lg:w-10 lg:h-10 border-white border-2 rounded-full flex justify-center 
          ...
          <div className="flex flex-row mt-4 gap-2 items-center">
            <p className="text-white text-[10px] lg:text-sm"> {data.genra}</p>
          </div>
        </div>
      </div>
    </div>
